...
public class HeaderArquivo implements FebrabanSegmento<HeaderArquivo>{
	...
	public IntField TipodeInscricaodaEmpresa = new IntField (" Tipo de Inscrição da Empresa ", true, 18 , 18, 2l ); 
	...
	public IntField CodigoRemessaRetorno = new IntField (" Código Remessa / Retorno ", true, 143 , 143, 1l ); 
	...
	@Override
	public HeaderArquivo fromLinha(String line) throws Exception {
		try{
			for(AntaresField<?> f : fields){
				f.fromLine(line);
			}
