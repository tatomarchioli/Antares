...
public	class TrailerArquivo implements FebrabanSegmento<TrailerArquivo>{
	...
	public IntField LotedeServico = new IntField (" Lote de Serviço ", true, 4 , 7, 9999 ); 
	public IntField TipodeRegistro = new IntField (" Tipo de Registro ", true, 8 , 8 , 9 );
	...
	@Override
	public TrailerArquivo setFromLine(String line) throws Exception {
		try{
			for(AntaresField f : fields){
