...
public class Header implements FebrabanSegmento<Header>{
	...
	public IntField TipodeRegistro = new IntField ("Tipo de Registro", true, 8 , 8 , 1l );
	...
	public IntField TipodeInscricaodaEmpresa = new IntField ("Tipo de Inscrição da Empresa", false, 18 , 18, 2l ); 
	...
	public IntField AgenciaMantenedoradaConta = new IntField ("Agência Mantenedora da Conta", true, 53 , 57, 3044l ); 
	public StringField DigitoVerificadordaAgencia = new StringField ("Dígito Verificador da Agência", false, 58 , 58 );
	public IntField NumerodaContaCorrente = new IntField ("Número da Conta Corrente", true, 59 , 70, 13003935l); 
	public IntField DigitoVerificadordaConta = new IntField ("Dígito Verificador da Conta", true, 71 , 71, 7l ); 
	...
	@Override
	public Header fromLinha(String line) throws Exception {
		try{
			for(AntaresField<?> f : fields){
				f.fromLine(line);
			}
